...
public class JobHandler {
	 ...
	 public Job getFirstJob(String job_name,String input_path,String output_path)
	 {
		 Job job = null;
		  try {
		    ...
		    //job.setCombinerClass(GraphReducer3.class);
	 ...
	 public Job getDataJob(String job_name,String input_path,String output_path)
	 {
		 Job job2 = null;
		 try{
		 job2=new Job(conf, job_name);
		 job2.setJarByClass(MapReduce3.class);
	 ...
	 public Job getDataCombinerJob(String job_name,ArrayList<String> input_path,String output_path)
	 {
		 Job job2 = null;
		  try {
			  job2 = new Job(conf, job_name);
		    job2.setJarByClass(MapReduce3.class);
		    job2.setMapperClass(DataCombinerMapper.class);
		    //job.setCombinerClass(GraphReducer.class);
		    job2.setReducerClass(DataCombinerReducer.class);
		    ...
		    job2.setMapOutputKeyClass(LongWritable.class);
		    job2.setMapOutputValueClass(Text.class);
		    job2.setNumReduceTasks(10);   //increase this as size of input data increases
		    
				FileInputFormat.addInputPath(job2, new Path(input_path.get(0)));
				FileInputFormat.addInputPath(job2, new Path(input_path.get(1)));
	 ...
	 public Job getResultFilterJob(String job_name,String input_path,String output_path)
	 {
		 Job job2 = null;
		  try {
			  job2 = new Job(conf, job_name);
		    job2.setJarByClass(MapReduce3.class);
		    job2.setMapperClass(ResultDataMapper.class);
		    //job.setCombinerClass(GraphReducer.class);
		    job2.setReducerClass(DataCombinerReducer.class);
