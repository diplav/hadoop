...
/*
 * This mapper and reducer will be used to extract the 
 * records which needs to be updated for this iteration.
 */
	  
	  public  class DataMapper extends Mapper<Object, Text, LongWritable, Text>{
