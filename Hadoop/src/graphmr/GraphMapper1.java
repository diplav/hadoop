  ...
  public  class GraphMapper1 extends Mapper<Object, Text, LongWritable, Text>{
    ...
    public void map(Object key, Text value, Context context ) throws IOException, InterruptedException {
    	...
    	while (itr.hasMoreTokens()) {  
    		...
    		/*
    		 * If the color is red make it as black and make it's destination as red.
    	  ...
    	  if(color.equals("R"))
    	  {
    		  ...
    		  if(!contains(arr[3],arr[1]))
    			  context.write(new LongWritable(new Long(arr[1])),new Text(arr[1]+","+arr[1]+","+arr[2]+","+arr[3]+"|"+arr[1]+",R"));
    	  }
